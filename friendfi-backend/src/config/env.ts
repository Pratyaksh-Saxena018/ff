...
const envSchema = z.object({
  ...
  INITIAL_KARMA: z.string().transform(Number).default('500'),
  KARMA_FORGIVE_BULLY: z.string().transform(Number).default('5'),
  KARMA_SANCTION_BULLY: z.string().transform(Number).default('-15'),
  KARMA_JUROR_ALIGNED: z.string().transform(Number).default('5'),
  KARMA_JUROR_MISALIGNED: z.string().transform(Number).default('-1'),
  REPEAT_OFFENDER_MULTIPLIER: z.string().transform(Number).default('1.5'),
